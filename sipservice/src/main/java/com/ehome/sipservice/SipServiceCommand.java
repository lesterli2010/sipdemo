...
public class SipServiceCommand {
    ...
    protected static final String ACTION_SET_SIP_STACK_LOG_LEVEL = "setSipStackLogLevel";
    ...
    protected static final String PARAM_LOG_LEVEL = "logLevel";
    ...
    /**
     * Set Sip Stack Log Level, this shall be called before sip stack is started
     * @param context
     * @param logLevel
     */
    public static void setSipStackLogLevel(Context context, long logLevel) {
        Intent intent = new Intent(context, SipService.class);
        intent.setAction(ACTION_SET_SIP_STACK_LOG_LEVEL);
