...
import static com.ehome.sipservice.SipServiceCommand.ACTION_ACCEPT_INCOMING_CALL;
import static com.ehome.sipservice.SipServiceCommand.ACTION_DECLINE_INCOMING_CALL;
import static com.ehome.sipservice.SipServiceCommand.ACTION_GET_CALL_STATUS;
import static com.ehome.sipservice.SipServiceCommand.ACTION_GET_CODEC_PRIORITIES;
import static com.ehome.sipservice.SipServiceCommand.ACTION_GET_REGISTRATION_STATUS;
import static com.ehome.sipservice.SipServiceCommand.ACTION_HANG_UP_CALL;
import static com.ehome.sipservice.SipServiceCommand.ACTION_HANG_UP_CALLS;
import static com.ehome.sipservice.SipServiceCommand.ACTION_HOLD_CALLS;
import static com.ehome.sipservice.SipServiceCommand.ACTION_MAKE_CALL;
import static com.ehome.sipservice.SipServiceCommand.ACTION_REMOVE_ACCOUNT;
import static com.ehome.sipservice.SipServiceCommand.ACTION_RESTART_SIP_STACK;
import static com.ehome.sipservice.SipServiceCommand.ACTION_SEND_DTMF;
import static com.ehome.sipservice.SipServiceCommand.ACTION_SET_ACCOUNT;
import static com.ehome.sipservice.SipServiceCommand.ACTION_SET_CODEC_PRIORITIES;
import static com.ehome.sipservice.SipServiceCommand.ACTION_SET_HOLD;
import static com.ehome.sipservice.SipServiceCommand.ACTION_SET_MUTE;
import static com.ehome.sipservice.SipServiceCommand.ACTION_SET_SIP_STACK_LOG_LEVEL;
import static com.ehome.sipservice.SipServiceCommand.ACTION_TOGGLE_HOLD;
import static com.ehome.sipservice.SipServiceCommand.ACTION_TOGGLE_MUTE;
import static com.ehome.sipservice.SipServiceCommand.ACTION_TRANSFER_CALL;
import static com.ehome.sipservice.SipServiceCommand.AGENT_NAME;
import static com.ehome.sipservice.SipServiceCommand.PARAM_ACCOUNT_DATA;
import static com.ehome.sipservice.SipServiceCommand.PARAM_ACCOUNT_ID;
import static com.ehome.sipservice.SipServiceCommand.PARAM_CALL_ID;
import static com.ehome.sipservice.SipServiceCommand.PARAM_CODEC_PRIORITIES;
import static com.ehome.sipservice.SipServiceCommand.PARAM_DTMF;
import static com.ehome.sipservice.SipServiceCommand.PARAM_HOLD;
import static com.ehome.sipservice.SipServiceCommand.PARAM_LOG_LEVEL;
import static com.ehome.sipservice.SipServiceCommand.PARAM_MUTE;
import static com.ehome.sipservice.SipServiceCommand.PARAM_NUMBER;
...
public class SipService extends BackgroundService {
    ...
    public int onStartCommand(final Intent intent, int flags, int startId) {
        enqueueJob(new Runnable() {
            ...
            public void run() {
                ...
                } else if (ACTION_SET_SIP_STACK_LOG_LEVEL.equals(action)) {
                    handleSetSipStackLogLevel(intent);
                }
    ...
    private void notifyCallDisconnected(String accountID, int callID) {
        notifyCallDisconnected(accountID, callID, 0);
    }
    private void notifyCallDisconnected(String accountID, int callID, int statusCode) {
        mBroadcastEmitter.callState(accountID, callID,
                pjsip_inv_state.PJSIP_INV_STATE_DISCONNECTED.swigValue(), statusCode, 0, false, false);
    }
    ...
    private void handleGetCallStatus(Intent intent) {
        ...
        mBroadcastEmitter.callState(accountID, callID, sipCall.getCurrentState().swigValue(), 0,
    ...
    private void startStack() {
        ...
        try {
            ...
            // mLogLevel = 5;
            Logger.debug(TAG, "init log:" + mLogLevel);
            if (mLogLevel != 0) {
                // set log config
                epConfig.getLogConfig().setLevel(mLogLevel);
                epConfig.getLogConfig().setConsoleLevel(mLogLevel);
            ...
            if (codecPriorities != null) {
                ...
                mEndpoint.codecSetPriority("PCMA/8000", (short) (CodecPriority.PRIORITY_MAX));
                mEndpoint.codecSetPriority("PCMU/8000", (short) (CodecPriority.PRIORITY_MAX));
                ...
                mEndpoint.codecSetPriority("G722/16000", (short) (CodecPriority.PRIORITY_MAX));
    ...
    private void handleSetSipStackLogLevel(Intent intent) {
        mLogLevel = intent.getLongExtra(PARAM_LOG_LEVEL, 0);
    }
